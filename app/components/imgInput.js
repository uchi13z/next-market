...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try{
            ...
            data.append("upload_preset", "hpgguo37")
            data.append("cloud_name","daiu0gwit")
            const response= await fetch("https://api.cloudinary.com/v1_1/daiu0gwit/image/upload", {method: "POST", body: data})
